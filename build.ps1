...
Remove-Item -LiteralPath (Join-Path $PSScriptRoot 'dist') -Recurse -Force -ErrorAction Stop
Remove-Item -LiteralPath (Join-Path $PSScriptRoot 'build\pyinstaller') -Recurse -Force -ErrorAction Stop
